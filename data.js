...
const LANDSCAPE = {
  ...
  tools: [
    ...
    // ── LLM Model Routing ──────────────────────────────────────────────────
    {
      id: 'routerbench',
      name: 'RouterBench',
      shortName: 'RouterBench',
      initials: 'RB',
      logo: 'logos/routerbench.png',
      stars: 175,
      forks: 33,
      description:
      ...
      huggingface: 'https://huggingface.co/datasets/withmartian/routerbench',
      license: 'Apache 2.0',
      org: 'Martian / UC Berkeley',
      metrics: [
        'Average improvement in quality (AIQ)',
        'Cost per query',
        'Routing accuracy',
        'Deferral curve (quality vs cost)',
      ],
      tags: ['routerbench', 'routing', 'martian', 'cost', 'multi-llm'],
    },
    {
      id: 'llmrouterbench',
      name: 'LLMRouterBench',
      shortName: 'LLMRouterBench',
      initials: 'LR',
      logo: 'logos/llmrouterbench.png',
      stars: 94,
      forks: 15,
      description:
      ...
      paper: 'https://aclanthology.org/2026.findings-acl.1881/',
      license: 'Apache 2.0',
      org: 'LLMRouterBench',
      metrics: [
        'Routing recall',
        ...
        'Oracle gap',
        'Latency-aware routing score',
      ],
      tags: ['llmrouterbench', 'routing', 'benchmark', 'cost'],
    },
    {
      id: 'routellm',
      name: 'RouteLLM',
      ...
      huggingface: 'https://huggingface.co/routellm',
      license: 'Apache 2.0',
      org: 'UC Berkeley LMSYS',
      metrics: [
        'Win rate vs strong model',
        'Cost reduction',
        'Routing threshold calibration',
        'MT-Bench / MMLU quality retention',
      ],
      tags: ['routellm', 'lmsys', 'berkeley', 'routing', 'cost'],
    },
    {
      ...
      shortName: 'vLLM SR',
      initials: 'SR',
      logo: 'logos/vllm-semantic-router.png',
      stars: 5163,
      forks: 819,
      description:
      ...
      docs: 'https://vllm-sr.ai',
      paper: 'https://arxiv.org/html/2603.04444v4',
      license: 'Apache 2.0',
      org: 'vLLM Project',
      metrics: [
        'Routing accuracy',
    ...
    // ── Benchmark Orchestration ────────────────────────────────────────────
    {
      ...
      shortName: 'cpueval',
      initials: 'CE',
      logo: 'logos/vllm-cpu-perf-eval.png',
      stars: 8,
      forks: 6,
      description:
    ...
    },
    {
      ...
      initials: 'LD',
      logo: 'logos/llm-d-benchmark.png',
      stars: 64,
      forks: 130,
      description:
    ...
    },
    {
      ...
      forks: 1579,
      description:
        'Framework for evaluating and optimizing agents and language models — runs arbitrary agents (Claude Code, OpenHands, Codex CLI) against benchmarks like Terminal-Bench and SWE-Bench in parallel across Docker, Kubernetes, and cloud providers (Daytona, Modal, LangSmith).',
      category: 'benchmark-orchestration',
      hardware: ['cpu', 'gpu'],
      types: ['online', 'offline'],
      ...
      lastReviewed: '2026-08-17',
      useCases: ['pre-production', 'ci-friendly', 'research'],
      related: ['swe-bench', 'agentbench', 'webarena', 'langsmith'],
      hosting: 'both',
      outputFormats: ['json'],
      modelScope: 'agnostic',
      adoption: 'both',
      datasets: ['Terminal-Bench', 'SWE-Bench', 'Aider Polyglot'],
      metrics: [
        'Task success rate',
        'Agent accuracy',
        'Concurrent environment throughput',
        'Per-dataset pass rate',
      ],
      tags: ['harbor', 'agent-eval', 'orchestration', 'docker', 'cloud', 'terminal-bench'],
    },
  ],
};
...
const RELATED_MAP = {
  'vllm-serve':       ['guidellm', 'llmperf', 'genai-perf', 'tgi-bench', 'vllm-cpu-perf-eval', 'llm-d-benchmark', 'vllm-semantic-router', 'routellm'],
  'vllm-throughput':  ['tensorrt-llm', 'perf-analyzer'],
  'guidellm':         ['vllm-serve', 'llmperf', 'genai-perf', 'vllm-cpu-perf-eval', 'llm-d-benchmark', 'llm-d-bench', 'routellm'],
  'llmperf':          ['vllm-serve', 'guidellm', 'tgi-bench', 'routellm'],
  'genai-perf':       ['vllm-serve', 'perf-analyzer', 'tensorrt-llm', 'llm-d-benchmark'],
  'routerbench':      ['llmrouterbench', 'routellm', 'vllm-semantic-router'],
  'llmrouterbench':   ['routerbench', 'routellm', 'vllm-semantic-router'],
  'routellm':         ['routerbench', 'vllm-semantic-router', 'llmrouterbench'],
  'vllm-semantic-router': ['vllm-serve', 'routellm', 'routerbench'],
  'mmr-bench':        ['mmmu', 'mmbench', 'vllm-semantic-router'],
  ...
  'harbor':           ['swe-bench', 'agentbench', 'webarena', 'langsmith'],
  'mlcommons-cm':     ['mlperf'],
...
const TOOL_META = {
  ...
  'routerbench': {
    hosting: 'library', outputFormats: ['json', 'csv'], modelScope: 'agnostic',
    adoption: 'research', foundation: 'Martian', datasets: ['RouterBench'],
  },
  'llmrouterbench': {
    hosting: 'library', outputFormats: ['json'], modelScope: 'agnostic',
    adoption: 'research', datasets: ['LLMRouterBench'],
  },
  'routellm': {
    hosting: 'both', outputFormats: ['json'], modelScope: 'openai-compatible',
    adoption: 'both', foundation: 'UC Berkeley LMSYS', datasets: ['Chatbot Arena preferences'],
  },
  'vllm-semantic-router': {
    hosting: 'self-hosted', outputFormats: ['json', 'prometheus'], modelScope: 'openai-compatible',
    adoption: 'both', foundation: 'vLLM', datasets: ['custom signal rules'],
  },
  'mmr-bench': {
    hosting: 'library', outputFormats: ['json', 'csv'], modelScope: 'agnostic',
    adoption: 'research', datasets: ['MMR-Bench'],
  },
  'llmperf': {
